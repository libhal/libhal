...
#include <libhal/tracked_ptr.hpp>
...
{
public:
  explicit blinker(tracked_ptr<custom_output_pin>&& p_ptr)
  ...
  tracked_ptr<custom_output_pin> m_ptr;
};
...
boost::ut::suite<"tracked_ptr"> tracked_ptr_test = [] {
  ...
  "lifetime_observer"_test = []() {
    ...
    [[maybe_unused]] auto test_scope = []() {
      unique_observer<hal::custom_output_pin> test_pin;
