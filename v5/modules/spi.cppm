 ...
 * to an SD card driver and operate at 12 MHz whereas another spi channel can be
 * set to 1 MHz to communicate with a sensor that can only handle speeds up
 * to 1 MHz maximum.
 *
 */
export class spi_channel
{
public:
