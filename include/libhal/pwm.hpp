...
public:
  ...
  /**
   * @brief Set the waveform frequency for a single or group of pwm channels
   *
   ...
   * duty cycle remains approximately the same. If the frequency is changed from
   * 1kHz to 2kHz and the duty cycle for a pwm channel is 50%, then the duty
   * cycle must remain in 50%.
   *
